...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE2{
  ...
  UINT8   Enable;
  UINT8   Setting;
} SIO_EXTENSIVE_TABLE_TYPE2;

typedef struct _SIO_EXTENSIVE_TABLE_MAINTYPE{
  UINT8   Type;
  UINT8   Length;  
  UINT8   Device;
  UINT8   DeviceInstance;
} SIO_EXTENSIVE_TABLE_MAINTYPE;

typedef struct SIO_EXTENSIVE_TABLE_TITLE{
  UINT8   Title;
  UINT8   Length;
  UINT8   SioInstance;
  UINT8   Reserve;
} SIO_EXTENSIVE_TABLE_TITLE;
#pragma pack ()

// Define Type
#define TITLE                       0xF0
#define MAIN_TYPE                   0x00
#define SUBTYPE2                    0x02
#define SUBTYPE3                    0x03
#define SUBTYPE4                    0x04
#define SUBTYPE5                    0x05
#define SUBTYPE6                    0x06
#define SUBTYPE7                    0x07
#define SUBTYPE8                    0x08
#define SUBTYPE9                    0x09
#define SUBTYPE0                    0x0A
