...
/**
 ...
 @param[in]  ProtocolGuid    Provides the protocol to search for
...
/**
 ...
 @param[in] OldPool         A pointer to the buffer whose size is being adjusted.
 @param[in] OldSize         The size of the current buffer.
 @param[in] NewSize         The size of the new buffer.
...
/**
 ...
 @param[in] VarName            A Null-terminated Unicode string that is
                               the name of the vendor's variable.
 @param[in] VarGuid            A unique identifier for the vendor.
...
/**
 ...
 @return A string located from the Data Hub records based on the device path.
 @return NULL  If failed to get the String from Data Hub.
**/
UINT16 *
...
/**
 ...
 @retval Other value if BMM return unsuccessfully.
**/
EFI_STATUS
BdsStartBootMaint (
  VOID
...
/**
 ...
 @retval Other value if the Setup Browser process BMM's pages and return unsuccessfully.
**/
EFI_STATUS
FormSetDispatcher (
  IN  BMM_CALLBACK_DATA    *CallbackData
