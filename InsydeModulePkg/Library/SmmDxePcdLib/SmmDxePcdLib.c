  ...
  )
{
  ...
  if (mSmst != NULL) {
    Status = mSmst->SmmLocateProtocol (&gEfiPcdProtocolGuid, NULL, (VOID **) &mPiPcd);
  ...
  )
{
  ...
  if (mSmst != NULL) {
    Status = mSmst->SmmLocateProtocol (&gPcdProtocolGuid, NULL, (VOID **) &mPcd);
    if (Status == EFI_SUCCESS) {
      return mPcd;
    }
  }
  ...
  )
{
  ...
  if (mSmst != NULL) {
    Status = mSmst->SmmLocateProtocol (&gEfiGetPcdInfoProtocolGuid, NULL, (VOID **) &mPiPcdInfo);
    if (Status == EFI_SUCCESS) {
      return mPiPcdInfo;
    }
  }
  ...
  )
{
  ...
  if (mSmst != NULL) {
    Status = mSmst->SmmLocateProtocol (&gGetPcdInfoProtocolGuid, NULL, (VOID **) &mPcdInfo);
    if (Status == EFI_SUCCESS) {
      return mPcdInfo;
    }
  }
