/** @file
 Font database protocol implementation
...
extern UINT16         mFontWideGlyphNumber;
...
EFI_FONT_PACKAGE_HEAD     FONT_PACKAGE_HEAD =
                           { {'$', 'F', 'O', 'N', 'T', 'P', 'K', 'G'},
                             ...
                             0,                                    0,
                             0,                                    0,
                             (UINT32)(UINTN)mFontWideGlyphData,    0,
                             (UINT32)(UINTN)&mFontWideGlyphNumber, 0,
                             (UINT32)(UINTN) "ja-JP",              0
                           };
//
// Globals
//
  ...
  )
{
  ...
  //
  mFontDatabase.NumOfWideGlyph = mFontWideGlyphNumber;
