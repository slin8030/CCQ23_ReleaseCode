/** @file
 Expression function for SetupBrowserDxe driver
...
/**
 ...
 @param[in, out] String  The Unicode character to be converted.
**/
VOID
IfrStrToUpper (
...
Done:
  ScuSafeFreePool ((VOID **)&String[0]);
  ScuSafeFreePool ((VOID **)&String[1]);
