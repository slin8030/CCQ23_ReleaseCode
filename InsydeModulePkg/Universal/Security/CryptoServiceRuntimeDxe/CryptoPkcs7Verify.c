  ...
  )
{
  ...
  for (Index = 0; ; Index++) {
    ...
    //
    if (Pkcs7Verify (SignedData, SignedDataSize, RevokedCert, RevokedCertSize, InData, InDataSize, FALSE)) {
      //
  ...
  )
{
  ...
  for (Index = 0; ; Index++) {
    ...
    //
    if (Pkcs7Verify (SignedData, SignedDataSize, TrustCert, TrustCertSize, InData, InDataSize, FALSE)) {
      //
