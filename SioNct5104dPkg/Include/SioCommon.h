...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE3 {
  ...
  UINT8  Enable;
  UINT8  IrqInfo;
} SIO_NCT5104D_ACPI_IRQ_INFORMATION;
...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE11 {
  ...
  UINT8  Tolerance;
} SIO_NCT5104D_SMART_FAN_THERMAL_CRUISE;
...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE12 {
  ...
  UINT8  MaximumTolerance;
  UINT8  Tolerance;
} SIO_NCT5104D_SMART_FAN_SPEED_CRUISE;
...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE20 {
  ...
  UINT8  GrnYlwSwitch;
  UINT8  Reserved[4];
} SIO_NCT5104D_LED_ADDITIONAL_FEATURE_SETTING;
...
typedef struct _SIO_EXTENSIVE_TABLE_TYPE22 {
  ...
  UINT8  SlopePwm;
} SIO_NCT5104D_SMART_FAN_GUARDIAN;
