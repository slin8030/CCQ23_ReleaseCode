...
//[-start-170308-IB07400847-modify]//
...
//[-end-170308-IB07400847-modify]//

  //
  //IaPcBootArch is only available in ACPI3.0 FACP
  //
  if ((SetupVariable->AcpiVer == 1) || (SetupVariable->AcpiVer == 2) || (SetupVariable->AcpiVer == 3)) {
