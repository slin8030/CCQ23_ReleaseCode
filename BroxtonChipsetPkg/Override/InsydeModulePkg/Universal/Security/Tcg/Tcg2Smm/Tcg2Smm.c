...
//[-start-160107-IB08450333-modify]#
  if ((CompareGuid (PcdGetPtr(PcdTpmInstanceGuid), &gTpmDeviceInstanceTpm20PttPtpGuid)) || (IsCrbInterfaceActive () && FeaturePcdGet (PcdH2OTpm2PtpSupported))) {
...
//[-start-160107-IB08450333-remove]#
//
// With the following operation, for fTPM the TPM device will disappear in Windows.
//
//  //
//  // Measure to PCR[0] with event EV_POST_CODE ACPI DATA
//  //
...
//[-start-160107-IB08450333-modify]#
  if (!CompareGuid (PcdGetPtr(PcdTpmInstanceGuid), &gEfiTpmDeviceInstanceTpm20DtpmGuid) &&
    ...
    DEBUG ((EFI_D_ERROR, "No TPM2 DTPM or PTT instance required!\n"));
