...
//[-start-160614-IB07400744-remove]//
//       ASSERT_EFI_ERROR (Status);
//[-end-160614-IB07400744-remove]//
        //
...
//[-start-160329-IB07400711-add]//
      DEBUG ((EFI_D_ERROR, "FwVolHeader = %x\n", FwVolHeader));
      DEBUG ((EFI_D_ERROR, "FwVolHeader End = %x\n", (BaseAddress + FwVolHeader->FvLength)));
      DEBUG ((EFI_D_ERROR, "FtwLiteDevice->WorkSpaceAddress = %x\n", FtwLiteDevice->WorkSpaceAddress));
      DEBUG ((EFI_D_ERROR, "FtwLiteDevice->SpareAreaAddress = %x\n", FtwLiteDevice->SpareAreaAddress));
...
//[-start-160329-IB07400711-add]//
        DEBUG ((EFI_D_ERROR, "FtwLiteDevice->FtwFvBlock = %x\n", Fvb));
//[-end-160329-IB07400711-add]//
        //
...
//[-start-160329-IB07400711-add]//
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->FtwWorkSpaceSize = %x\n", FtwLiteDevice->FtwWorkSpaceSize));
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->NumberOfFtwWorkBlock = %x\n", FtwLiteDevice->NumberOfFtwWorkBlock));
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->FtwWorkSpaceBase = %x\n", FtwLiteDevice->FtwWorkSpaceBase));
//[-end-160329-IB07400711-add]//
                break;
              }
            }
...
//[-start-160329-IB07400711-add]//
        DEBUG ((EFI_D_ERROR, "FtwLiteDevice->FtwBackupFvb = %x\n", Fvb));
//[-end-160329-IB07400711-add]//
        //
...
//[-start-160329-IB07400711-add]//
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->FtwSpareLba = %x\n", FtwLiteDevice->FtwSpareLba));
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->SizeOfSpareBlock = %x\n", FtwLiteDevice->SizeOfSpareBlock));
                DEBUG ((EFI_D_ERROR, "FtwLiteDevice->NumberOfSpareBlock = %x\n", FtwLiteDevice->NumberOfSpareBlock));
//[-end-160329-IB07400711-add]//
...
//[-start-160329-IB07400711-add]//
    FtwLiteDevice->WorkSpaceFvBaseAddr += PcdGet32(PcdFlashNvStorageVariableSize);
    DEBUG ((EFI_D_ERROR, "FtwLiteDevice->WorkSpaceFvBaseAddr = %x\n", FtwLiteDevice->WorkSpaceFvBaseAddr));
//[-end-160329-IB07400711-add]//
    //
...
//[-start-160329-IB07400711-add]//
    FtwLiteDevice->WorkSpaceFvBaseAddr += PcdGet32(PcdFlashNvStorageVariableSize);
    FtwLiteDevice->SpareAreaFvBaseAddr += (FtwLiteDevice->WorkSpaceFvBaseAddr + PcdGet32(PcdFlashNvStorageFtwSpareSize));
    DEBUG ((EFI_D_ERROR, "FtwLiteDevice->WorkSpaceFvBaseAddr = %x\n", FtwLiteDevice->WorkSpaceFvBaseAddr));
    DEBUG ((EFI_D_ERROR, "FtwLiteDevice->SpareAreaFvBaseAddr = %x\n", FtwLiteDevice->SpareAreaFvBaseAddr));
//[-end-160329-IB07400711-add]//
