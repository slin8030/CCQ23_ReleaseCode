...
#include <Library/DxeServicesTableLib.h>  // RPPO-CNL-0085: RoyalParkOverrideContent
#include <Library/SmmServicesTableLib.h>
#include <Library/UefiLib.h>  // RPPO-CNL-0085: RoyalParkOverrideContent
#include <Library/HobLib.h>
#include <Protocol/SmmAccess2.h>
#include <Protocol/SmmReadyToLock.h>
#include <Protocol/SmmEndOfDxe.h>
#include <Guid/MemoryAttributesTable.h>  // RPPO-CNL-0085: RoyalParkOverrideContent
...
BOOLEAN               mSmmMemLibSmmReadyToLock = FALSE;  // RPPO-CNL-0085: RoyalParkOverrideContent
  ...
  )
{
  ...
  //
  if (mSmmMemLibSmmReadyToLock) {  // RPPO-CNL-0085: RoyalParkOverrideContent
    ...
    if (!InValidCommunicationRegion) {
      DEBUG ((
        EFI_D_ERROR,
        "SmmIsBufferOutsideSmmValid: Not in ValidCommunicationRegion: Buffer (0x%lx) - Length (0x%lx)\n",  // RPPO-CNL-0085: RoyalParkOverrideContent
        Buffer,
        Length
        ));
      //ASSERT (FALSE);  // RPPO-CNL-0085: RoyalParkOverrideContent
      return FALSE;
    }
...
{
  mSmmMemLibSmmReadyToLock = TRUE;  // RPPO-CNL-0085: RoyalParkOverrideContent
  return EFI_SUCCESS;
}
/**
