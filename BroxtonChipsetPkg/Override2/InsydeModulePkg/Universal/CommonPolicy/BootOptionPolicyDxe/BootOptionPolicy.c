...
//  BootOptionPolicyData->BootNormalPriority                              = KernelConfiguration.BootNormalPriority;
  BootOptionPolicyData->BootNormalPriority                              = BootNormalPriorityData;
