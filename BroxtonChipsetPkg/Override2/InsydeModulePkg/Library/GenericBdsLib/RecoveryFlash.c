...
FlashComplete2 (
  IN     UINT16               Command,
  IN     UINT16               SmiPort,
  IN     UINT8                *CompleteStatus
  );

//[-start-170215-IB07400840-remove]//
//#define TXE_DEVICE_EXPANSION_BASE   0xFFF00000
//#define TXE_DEVICE_EXPANSION_SIZE   0x00100000
//[-end-170215-IB07400840-remove]//
  ...
  )
{
  ...
  FlashCompleteStatus.Signature      = FLASH_COMPLETE_STATUS_SIGNATURE;
  FlashCompleteStatus.StructureSize  = sizeof (FBTS_FLASH_COMPLETE_STATUS);
  FlashCompleteStatus.CompleteStatus = NormalFlash;

  FlashComplete2 (IHISI_REBOOT, FLASH_SMI_PORT, (UINT8*)&FlashCompleteStatus);
  return EFI_SUCCESS;
}
...
//[-start-160905-IB07400778-add]//
  EFI_STATUS                PrepareForUpdateStatus;
...
//[-start-160617-IB07400744-remove]//
//  BackupAuthVariable ();
//[-end-160617-IB07400744-remove]//
...
//[-start-160904-IB07400778-add]//
  //
  // Send Prepare for update command before update BIOS
  //
  PrepareForUpdateStatus = HeciIfwiPrepareForUpdate();
  DEBUG ((EFI_D_ERROR, "Send HeciIfwiPrepareForUpdate = %r\n", PrepareForUpdateStatus));
  if (EFI_ERROR (PrepareForUpdateStatus)) {
    // Request restore NVs in next boot
    WriteExtCmos8(R_XCMOS_INDEX, R_XCMOS_DATA, CmosRecoveryOnFlagAddress, V_CMOS_FAST_RECOVERY_RESTORE_NV);
  }
//[-end-160904-IB07400778-add]//
  //
...
//[-start-160615-IB07400744-modify]//
//[-start-170215-IB07400840-modify]//
    if ((FlashAddress >= PcdGet32(PcdFlashDeviceExpansionBase)) && ((UINT64)FlashAddress < ((UINT64)PcdGet32(PcdFlashDeviceExpansionBase) + (UINT64)PcdGet32(PcdFlashDeviceExpansionSize)))) {
...
//[-start-160905-IB07400778-modify]//
      if (!EFI_ERROR (PrepareForUpdateStatus)) {
        ...
        DEBUG ((EFI_D_ERROR, "Skip Device Expansion Region, FlashAddress = %x\n", FlashAddress));
      }
//[-end-160905-IB07400778-modify]//
    } else {
      CommTmp = FlashWrite (BufferTmp, FlashSize, FlashAddress, FLASH_SMI_PORT);
    }
//[-end-160615-IB07400744-modify]//
