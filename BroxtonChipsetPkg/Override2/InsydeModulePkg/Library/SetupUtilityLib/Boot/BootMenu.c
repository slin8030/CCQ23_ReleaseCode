...
//        if (KernelConfig->BootNormalPriority == EFI_FIRST) {
        if (BootNormalPriorityData == EFI_FIRST) {
...
//    if (KernelConfig->BootNormalPriority == LEGACY_FIRST) {
    if (BootNormalPriorityData == LEGACY_FIRST) {
//[-end-160923-IB07400788-modify]//
