...
//[-start-160923-IB07400789-add]//
  //
  // gBS can not be used after ACPI enabled.
  //
  gBS = NULL;
//[-end-160923-IB07400789-add]//
...
//[-start-160923-IB07400789-add]//
  //
  // Convert Legacy Free Pointer
  //
  if (mPrivate->KbcEmulator && IsKbcExist() == EFI_NOT_FOUND && GetLegacySupportProvider(&Usb3Hc) == EFI_SUCCESS) {
    //
    // Do not call Usb3Hc->LegacyHidSupport () directly since we are in DXE and
    // Usb3Hc->LegacyHidSupport () is in SMM. Trigger a sofrware SMI and call
    // Usb3Hc->LegacyHidSupport () in it.
    //
    IoWrite8 (SW_SMI_PORT + 1, 3);
    IoWrite8 (SW_SMI_PORT, USB_LEGACY_CONTROL_SW_SMI);
  }
//[-end-160923-IB07400789-add]//
}
