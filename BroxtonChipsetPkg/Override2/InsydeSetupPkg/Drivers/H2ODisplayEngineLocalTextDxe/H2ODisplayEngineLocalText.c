...
//[-start-190606-IB16530028-add]//
  LIST_ENTRY                                  *Link;
//[-end-190606-IB16530028-add]//
...
//[-start-190606-IB16530028-add]//
//
//Numbering the Node, avoid it detach wrong node and cause exception.
//
  if (!IsListEmpty (&Private->ConsoleDevListHead)) {
    Link = Private->ConsoleDevListHead.BackLink;
    ConDevNode = H2O_FORM_BROWSER_CONSOLE_DEV_NODE_FROM_LINK (Link);
    ConsoleDev->ConsoleId = (H2O_CONSOLE_ID)(ConDevNode->ConsoleDev->ConsoleId + 1);
  }
//[-end-190606-IB16530028-add]//
...
//[-start-190606-IB16530028-add]//
  DEBUG ((EFI_D_INFO, "LocalTextAttachConsole: %x ConsoleId: %x\n", ConDevNode, ConDevNode->ConsoleDev->ConsoleId));
//[-end-190606-IB16530028-add]//
...
//[-start-190606-IB16530028-add]//
      DEBUG ((EFI_D_INFO, "LocalTextDetachConsole: %x ConsoleId: %x\n", ConDevNode, ConDevNode->ConsoleDev->ConsoleId));
//[-end-190606-IB16530028-add]//
      //
...
//[-start-190606-IB16530028-add]//
//
//Avoid to build the node without DevicePath which might cause Front Page look weird.
//
