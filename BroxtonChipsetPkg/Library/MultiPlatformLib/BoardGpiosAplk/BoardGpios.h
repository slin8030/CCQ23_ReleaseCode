...
//[-start-170516-IB08450375-add]//
  BXT_GPIO_PAD_CONF(L"GPIO_10",                  M0   ,    GPO   ,  NA   ,  HI    ,   NA       , Wake_Disabled, P_20K_H,    NA   ,    NA     ,NA   ,     NA, GPIO_PADBAR+0x0050,  NORTH),
//[-end-170516-IB08450375-add]//
  ...
  BXT_GPIO_PAD_CONF(L"GPIO_12",                  M0   ,    GPI   , NA    ,  NA    ,   Level    , Wake_Enabled , P_20K_L,    NA   ,    SCI    ,TxDRxE,    NA, GPIO_PADBAR+0x0060,  NORTH),//Feature: LB
...
BXT_GPIO_PAD_INIT  mBXT_GpioInitData_NW_BFH_IVI [] =
{
  //                 Group Pin#:  pad_name,     PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger, Wake_Enabled, Term_H_L,Inverted,GPI_ROUT,IOSstae,  IOSTerm,    MMIO_Offset, Community
   ...
   BXT_GPIO_PAD_CONF(L"PMIC_RESET_B",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_NONE,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x00C8,  NORTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"PMIC_STDBY",               M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x00F0,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"PROCHOT_B",                M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA,HizRx1I   ,  SAME,     GPIO_PADBAR+0x00F8,  NORTHWEST),
...
// North Community
BXT_GPIO_PAD_INIT  mBXT_GpioInitData_N_MRB_IVI[] =
{
  /*                  Group Pin#:  pad_name,    PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger,  Wake_Enabled ,Term_H_L,Inverted, GPI_ROUT, IOSstae, IOSTerm,MMIO_Offset,Community */
   BXT_GPIO_PAD_CONF(L"GPIO_0",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0000,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_1",                   M0   ,    GPO   ,  NA   ,   LO    ,   NA      , Wake_Disabled,  P_20K_L ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0008,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_2",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0010,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_3",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0018,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_4",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0020,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_5",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0028,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_6",                   M0   ,    GPO   ,  NA   ,   LO    ,   NA      , Wake_Disabled,  P_20K_L ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0030,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_7",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0038,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_8",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0040,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_9",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0048,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_10",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0050,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_11",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0058,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_12",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0060,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_13",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0068,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_14",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0070,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_15",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0078,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_16",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0080,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_17",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0088,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_18",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0090,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_19",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0098,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_20",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x00A0,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_21",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x00A8,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_22",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x00B0,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_23",                  M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x00B8,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_24",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00C0,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_25",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00C8,  NORTH),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_28",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00E0,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_29",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00E8,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_30",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00F0,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_31",                  M0   ,    GPO   ,  NA   ,   HI    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x00F8,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_32",                  M0   ,    GPO   ,  NA   ,   LO    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0100,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_33",                  M0   ,    GPO   ,  NA   ,   LO    ,   NA      , Wake_Disabled,  P_NONE ,   NA    ,    NA,NA        ,  NA  ,    GPIO_PADBAR+0x0108,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_34 PWM0",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0110,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_35 PWM1",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0118,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_36 PWM2",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0120,  NORTH),
   BXT_GPIO_PAD_CONF(L"GPIO_37 PWM3",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,    GPIO_PADBAR+0x0128,  NORTH),
...
// North West Community
BXT_GPIO_PAD_INIT  mBXT_GpioInitData_NW_MRB_IVI [] =
{
  //                 Group Pin#:  pad_name,     PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger, Wake_Enabled, Term_H_L,Inverted,GPI_ROUT,IOSstae,  IOSTerm,    MMIO_Offset, Community
   BXT_GPIO_PAD_CONF(L"GPIO_187 HV_DDI0_DDC_SDA", M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0000,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_188 HV_DDI0_DDC_SCL", M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0008,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_189 HV_DDI1_DDC_SDA", M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0010,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_190 HV_DDI1_DDC_SCL", M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0018,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_191 DBI_SDA",         M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0020,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_192 DBI_SCL",         M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0028,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_193 PANEL0_VDDEN",    M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0030,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_194 PANEL0_BKLTEN",   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0038,  NORTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_197 PANEL1_BKLTEN",   M0  ,     GPO   ,GPIO_D,   HI    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,NA        ,    NA,   GPIO_PADBAR+0x0050,  NORTHWEST),//DISP1_BKLTEN
   BXT_GPIO_PAD_CONF(L"GPIO_198 PANEL1_BKLTCTL",  M0  ,     GPO   ,GPIO_D,   HI    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,NA        ,    NA,   GPIO_PADBAR+0x0058,  NORTHWEST),//DISP1_BLTCTL
   BXT_GPIO_PAD_CONF(L"GPIO_199 DBI_CSX",         M2   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0060,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_200 DBI_RESX",        M2   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0068,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_201 GP_INTD_DSI_TE1", M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0070,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_202 GP_INTD_DSI_TE2", M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0078,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_203 USB_OC0_B",       M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0080,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_204 USB_OC1_B",       M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I   ,EnPd  ,     GPIO_PADBAR+0x0088,  NORTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"PMIC_I2C_SCL",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0100,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"PMIC_I2C_SDA",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0108,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_74 AVS_I2S1_MCLK",    M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0110,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_75 AVS_I2S1_BCLK",    M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0118,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_76 AVS_I2S1_WS_SYNC", M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0120,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_77 AVS_I2S1_SDI",     M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0128,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_78 AVS_I2S1_SDO",     M1  ,     NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0130,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_79 AVS_M_CLK_A1",     M2  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0138,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_80 AVS_M_CLK_B1",     M2  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0140,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_81 AVS_M_DATA_1",     M2  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0148,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_82 AVS_M_CLK_AB2",    M2  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_NONE,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0150,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_83 AVS_M_DATA_2",     M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0158,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_84 AVS_I2S2_MCLK",    M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0160,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_85 AVS_I2S2_BCLK",    M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0168,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_86 AVS_I2S2_WS_SYNC", M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0170,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_87 AVS_I2S2_SDI",     M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0178,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_88 AVS_I2S2_SDO",     M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA,HizRx0I   ,  EnPd,     GPIO_PADBAR+0x0180,  NORTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_109 GP_SSP_0_RXD",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0200,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_110 GP_SSP_0_TXD",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0208,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_111 GP_SSP_1_CLK",    M1   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_L,   NA    ,    NA  ,HizRx0I,  EnPd,     GPIO_PADBAR+0x0210,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_112 GP_SSP_1_FS0",    M1   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_H,   NA    ,    NA  ,HizRx0I,  EnPd,     GPIO_PADBAR+0x0218,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_113 GP_SSP_1_FS1",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0220,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_116 GP_SSP_1_RXD",    M1   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_H,   NA    ,    NA  ,HizRx0I,  EnPd,     GPIO_PADBAR+0x0228,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_117 GP_SSP_1_TXD",    M1   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_20K_H,   NA    ,    NA  ,HizRx0I,  EnPd,     GPIO_PADBAR+0x0230,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_118 GP_SSP_2_CLK",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0238,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_119 GP_SSP_2_FS0",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0240,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_120 GP_SSP_2_FS1",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0248,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_121 GP_SSP_2_FS2",    M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0250,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_122 GP_SSP_2_RXD",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0258,  NORTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_123 GP_SSP_2_TXD",    M1  ,     NA    ,NA    ,  NA     ,   NA      ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I        ,EnPd    ,     GPIO_PADBAR+0x0260,  NORTHWEST),
};
// West Community
BXT_GPIO_PAD_INIT  mBXT_GpioInitData_W_MRB_IVI [] =
{
  //                   Group Pin#:  pad_name,    PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger,Wake_Enabled, Term_H_L, Inverted,GPI_ROUT,IOSstae, IOSTerm,   MMIO_Offset, Community
   BXT_GPIO_PAD_CONF(L"GPIO_124 LPSS_I2C0_SDA",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x0000,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_125 LPSS_I2C0_SCL",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0008,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_126 LPSS_I2C1_SDA",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0010,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_127 LPSS_I2C1_SCL",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0018,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_128 LPSS_I2C2_SDA",   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0020,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_129 LPSS_I2C2_SCL",   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0028,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_130 LPSS_I2C3_SDA",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0030,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_131 LPSS_I2C3_SCL",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0038,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_132 LPSS_I2C4_SDA",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0040,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_133 LPSS_I2C4_SCL",   M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA, HizRx0I,  EnPu,     GPIO_PADBAR+0x0048,  WEST),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_138 LPSS_I2C7_SDA",   M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I       ,EnPd    ,     GPIO_PADBAR+0x0070,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_139 LPSS_I2C7_SCL",   M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I       ,EnPd    ,     GPIO_PADBAR+0x0078,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_146 ISH_GPIO_0",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0080,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_147 ISH_GPIO_1",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0088,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_148 ISH_GPIO_2",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0090,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_149 ISH_GPIO_3",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0098,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_150 ISH_GPIO_4",      M2   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00A0,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_151 ISH_GPIO_5",      M2   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00A8,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_152 ISH_GPIO_6",      M2   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00B0,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_153 ISH_GPIO_7",      M2   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_NONE,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00B8,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_154 ISH_GPIO_8",      M0   ,    GPO   ,  NA   ,  HI    ,   NA       , Wake_Disabled, P_NONE,   NA   ,     NA,      NA  ,     NA,     GPIO_PADBAR+0x00C0,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_155 ISH_GPIO_9",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x00C8,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_209 PCIE_CLKREQ0_B",  M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00D0,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_210 PCIE_CLKREQ1_B",  M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00D8,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_211 PCIE_CLKREQ2_B",  M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00E0,  WEST),
   BXT_GPIO_PAD_CONF(L"GPIO_212 PCIE_CLKREQ3_B",  M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_H,   NA    ,    NA, HizRx0I,  EnPd,     GPIO_PADBAR+0x00E8,  WEST),
   BXT_GPIO_PAD_CONF(L"OSC_CLK_OUT_0",            M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x00F0,  WEST),
   BXT_GPIO_PAD_CONF(L"OSC_CLK_OUT_1",            M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x00F8,  WEST),
   BXT_GPIO_PAD_CONF(L"OSC_CLK_OUT_2",            M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0100,  WEST),
   BXT_GPIO_PAD_CONF(L"OSC_CLK_OUT_3",            M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,     GPIO_PADBAR+0x0108,  WEST),
...
// South West Community
BXT_GPIO_PAD_INIT  mBXT_GpioInitData_SW_MRB_IVI[]=
{
  //                  Group Pin#:  pad_name,       PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger,Wake_Enabled, Term_H_L,Inverted,GPI_ROUT,IOSstae, IOSTerm,MMIO_Offset, Community
   BXT_GPIO_PAD_CONF(L"GPIO_205 PCIE_WAKE0_B",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0000 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_206 PCIE_WAKE1_B",      M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0008 ,  SOUTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_164 EMMC0_D7",          M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0060 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_165 EMMC0_CMD",         M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0068 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_166 SDIO_CLK",          M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0070 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_167 SDIO_D0",           M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0078 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_168 SDIO_D1",           M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0080 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_169 SDIO_D2",           M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0088 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_170 SDIO_D3",           M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0090 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_171 SDIO_CMD",          M1  ,     NA   ,NA,  NA     ,   NA,Wake_Disabled, P_20K_H,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0098 ,  SOUTHWEST),
   ...
   BXT_GPIO_PAD_CONF(L"GPIO_186 SDCARD_LVL_WP",     M0,     GPI   , GPIO_D ,  NA     ,   Edge     ,Wake_Disabled, P_20K_L,Inverted ,    NA  ,Last_Value,SAME ,GPIO_PADBAR+0x00E0 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_182 EMMC0_STROBE",      M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x00E8 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"GPIO_183 SDIO_PWR_DOWN_B",   M0,       GPO   ,GPIO_D,  HI     ,   NA       ,Wake_Disabled, P_NONE,    NA   ,    NA  ,NA       ,NA    ,   GPIO_PADBAR+0x00F0 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"SMB_ALERTB",                 M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x00F8 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"SMB_CLK",                    M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0100 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"SMB_DATA",                   M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0108 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_ILB_SERIRQ",             M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0110 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_CLKOUT0",                M1,     NA    ,   NA   ,  NA     ,   NA       , Wake_Disabled, P_NONE,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0118 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_CLKOUT1",                M0  ,     GPI   ,GPIO_D,  NA     ,   Level,Wake_Disabled, P_NONE,    NA   ,    NA  ,NA        ,NA    ,   GPIO_PADBAR+0x0120 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_AD0",                    M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0128 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_AD1",                    M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0130 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_AD2",                    M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0138 ,  SOUTHWEST),
   BXT_GPIO_PAD_CONF(L"LPC_AD3",                    M1,     NA    ,   NA   ,  NA     ,   NA       ,Wake_Disabled, P_20K_H,    NA   ,    NA  ,HizRx0I  ,EnPd  ,   GPIO_PADBAR+0x0140 ,  SOUTHWEST),
...
HostSw:
* All GPIO pins which are 'M0' PMode, have to set HostSw to GPIO_D, indecating GPIO driver owns it.
* Others, such as Native function(M1,M2,M3..) and SCI/SMI/NMI/Direct IRQ, need to set it to ACPI_D or NA.
* Default is ACPI_D for NA
...
BXT_GPIO_PAD_INIT  mBXT_RVVP_GpioInitData_NW [] =
{
  ...
  BXT_GPIO_PAD_CONF(L"PMIC_RESET_B",             M1   ,    NA    , NA   ,   NA    ,   NA      ,Wake_Disabled, P_NONE,    NA    ,    NA  ,NA        ,  SAME,  GPIO_PADBAR+0x00C8,  NORTHWEST),//PMIC_RESET_L TODO: why Mike use L ??
  ...
  BXT_GPIO_PAD_CONF(L"PMIC_STDBY",               M1   ,    NA    , NA   ,   NA    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,NA        ,    NA,  GPIO_PADBAR+0x00F0,  NORTHWEST),//PMIC_STDBY
