...
/**
  ...
  @param[in]  FfsHeader   Pointer to FFS header the loaded driver.
  ...
  )
{
  ...
  TargetIsFtpm = EFI_ERROR(Status) ? TRUE : FALSE;
  return EFI_SUCCESS;
}
