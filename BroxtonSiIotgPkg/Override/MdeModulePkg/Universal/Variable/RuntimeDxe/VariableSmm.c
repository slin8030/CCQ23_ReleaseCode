  ...
  switch (SmmVariableFunctionHeader->Function) {
    ...
    case SMM_VARIABLE_FUNCTION_INIT_RUNTIME_VARIABLE_CACHE_CONTEXT:
      if (CommBufferPayloadSize < sizeof (SMM_VARIABLE_FUNCTION_INIT_RUNTIME_VARIABLE_CACHE_CONTEXT)) {
        ...
        VariableCacheContext->VariableRuntimeVolatileCache.PendingUpdateLength   = (UINT32)((UINT8 *)GetEndPointer (VolatileVariableCache) - (UINT8 *)GetStartPointer(VolatileVariableCache));
        ...
        VariableCacheContext->VariableRuntimeNvCache.PendingUpdateLength = (UINT32)((UINT8 *)GetEndPointer (mNvVariableCache) - (UINT8 *)GetStartPointer(mNvVariableCache));
