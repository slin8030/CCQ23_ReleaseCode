...
LPSS_I2C_CLOCK_SCL_INFO  mLPSS_I2C_CLOCK_SCL_INFO_2[] = {
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1a, 0x1c},
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1a, 0x1c},
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1a, 0x1c},
  {High_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1a, 0x1c},
  {High_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1a, 0x1c},
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1f, 0x1c},
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1f, 0x1c},
  {Fast_Speed, 0x244, 0x2D0, 0x68, 0xC3, 0x06, 0x1f, 0x1c},
};
  ...
  )
{
  ...
  //
  {
    ...
    //
       ...
       MmioWrite32 ((UINTN)LpssMmioBase0 + R_LPSS_IO_MEM_PCP, Value);
       MmioRead32 ((UINTN)LpssMmioBase0 + R_LPSS_IO_MEM_PCP);
     } else if ((mLpssIoDevices[DevIndex].PciDeviceNum == PCI_DEVICE_NUMBER_LPSS_I2C0) || (mLpssIoDevices[DevIndex].PciDeviceNum == PCI_DEVICE_NUMBER_LPSS_I2C1)){
       if (BxtStepping () >= BxtPF1){
        Value2 = MmioRead32 ((UINTN)(LpssMmioBase0 + R_LPSS_I2C_IC_ENABLE));
        DEBUG ((DEBUG_INFO, "R_LPSS_I2C_IC_ENABLE STATUS: 0x%08X\r\n", Value2));
        //Disable I2C :This register can be written only when the I2C interface is disabled,
        //which corresponds to the IC_ENABLE register being set to 0. Writes at other times have no effect.
        if (Value2 == 1){
          DEBUG((DEBUG_INFO, "Disabling I2C interface before writing I2C register \n\n"));
          MmioWrite32 ((UINTN) (LpssMmioBase0 + R_LPSS_I2C_IC_ENABLE), 0x0);
          DEBUG ((DEBUG_INFO, "R_LPSS_I2C_IC_ENABLE STATUS before writing I2C register: 0x%08X\r\n",\
          MmioRead32 ((UINTN)(LpssMmioBase0 + R_LPSS_I2C_IC_ENABLE))));
        }
        DEBUG((DEBUG_INFO, "Writing I2C register\n"));
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_SS_SCL_HCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].SS_SCL_HCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_SS_SCL_LCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].SS_SCL_LCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_FS_SCL_HCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].FS_SCL_HCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_FS_SCL_LCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].FS_SCL_LCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_HS_SCL_HCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].HS_SCL_HCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_HS_SCL_LCNT), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].HS_SCL_LCNT);
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_IC_SDA_HOLD), (UINT16)mLPSS_I2C_CLOCK_SCL_INFO_2[DevIndex].SDA_HOLD);
        DEBUG ((DEBUG_INFO, "R_IC_SS_SCL_HCNT: 0x%08X, R_IC_SS_SCL_LCNT: 0x%08X\r\n",\
          MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_SS_SCL_HCNT)), MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_SS_SCL_LCNT))));
        DEBUG ((DEBUG_INFO, "R_IC_FS_SCL_HCNT: 0x%08X, R_IC_FS_SCL_LCNT: 0x%08X\r\n",\
          MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_FS_SCL_HCNT)), MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_FS_SCL_LCNT))));
        DEBUG ((DEBUG_INFO, "R_IC_HS_SCL_HCNT: 0x%08X, R_IC_HS_SCL_LCNT: 0x%08X\r\n",\
          MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_HS_SCL_HCNT)), MmioRead32 ((UINTN)(LpssMmioBase0 + R_IC_HS_SCL_LCNT))));
        DEBUG ((DEBUG_INFO, "R_IC_SDA_HOLD: 0x%08X\r\n",MmioRead32((UINTN) (LpssMmioBase0 + R_IC_SDA_HOLD))));
        DEBUG((DEBUG_INFO, "Enabling I2C interface after writing I2C register\n"));
        MmioWrite32 ((UINTN) (LpssMmioBase0 + R_LPSS_I2C_IC_ENABLE), Value2);
        DEBUG ((DEBUG_INFO, "R_LPSS_I2C_IC_ENABLE STATUS after writing I2C register : 0x%08X\r\n",\
          MmioRead32 ((UINTN)(LpssMmioBase0 + R_LPSS_I2C_IC_ENABLE))));
      }
     }
  }
