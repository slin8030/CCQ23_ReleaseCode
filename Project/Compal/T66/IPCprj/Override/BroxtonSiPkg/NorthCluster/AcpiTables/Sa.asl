...
//PRJ+ <<<< Modify MIPI panel power sequency 
    ...
    {
//PRJ- >>>> Modify MIPI panel power sequency       If (LAnd (LNotEqual (PNSL, 0), LNotEqual (PNSL, 4))) {
        Return (CBUF)
//PRJ- >>>> Modify MIPI panel power sequency       } Else {
//PRJ- >>>> Modify MIPI panel power sequency     Return (DBUF)
//PRJ- >>>> Modify MIPI panel power sequency    }
    }
#else
