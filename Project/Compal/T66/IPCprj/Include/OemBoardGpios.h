...
BXT_GPIO_PAD_CONF(L"GPIO_9",                   M0   ,    GPO   ,GPIO_D,   LO    ,   NA      ,  Wake_Disabled, P_20K_L,   NA    ,    NA,NA        ,    NA, GPIO_PADBAR+0x0048,  NORTH),//NA->EDP, GPO->Mipi RST
//PRJ+ <<<< Modify MIPI panel power sequency
...
//PRJ+ >>>> Modify MIPI panel power sequency  
  BXT_GPIO_PAD_CONF(L"GPIO_196 PANEL1_VDDEN",    M0  ,     GPO   ,GPIO_D,  LO     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA     ,  GPIO_PADBAR+0x0048,  NORTHWEST),//PANEL1_VDD_EN
  BXT_GPIO_PAD_CONF(L"GPIO_197 PANEL1_BKLTEN",   M0  ,     GPO   ,GPIO_D,  LO     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,NA        ,NA    ,  GPIO_PADBAR+0x0050,  NORTHWEST),//PNL1_BKLTEN
