...
#ifndef _BOARDGPIOS_OXBOW_HILL_H_
#define _BOARDGPIOS_OXBOW_HILL_H_

//[-start-161130-IB07400820-modify]//
...
//[-start-170518-IB07400867-modify]//
  BXT_GPIO_PAD_CONF(L"GPIO_10",                  M0   ,    GPO   ,  NA   ,  HI    ,   NA       , Wake_Disabled, P_20K_H,    NA   ,    NA,     NA   ,     NA, GPIO_PADBAR+0x0050,  NORTH), //*J2P1.56 NGFF_3P3_KILL_WIFI_N
...
#ifndef SIC_GPIO12_EXAMPLE_CODE
  BXT_GPIO_PAD_CONF(L"GPIO_12",                  M1   ,    NA    ,  NA   ,  NA    ,   NA       , Wake_Enabled , P_20K_L,   NA    ,    NA,     NA   ,     NA, GPIO_PADBAR+0x0060,  NORTH), //*J2M1.44 GPIO12
#else
  BXT_GPIO_PAD_CONF(L"GPIO_12",                  M0   ,    GPI   , NA    ,  NA    ,   Level    , Wake_Enabled , P_20K_L,    NA   ,    SCI    ,TxDRxE,    NA, GPIO_PADBAR+0x0060,  NORTH), //*J2M1.44 GPIO12, Update from SIC 1.4.0
#endif
...
//[-start-161216-IB07400826-modify]//
  ...
  BXT_GPIO_PAD_CONF(L"GPIO_44 LPSS_UART1_RTS_B", M0   ,    GPI   , ACPI_D,  NA    ,   Level    , Wake_Disabled,  P_NONE, Inverted,   SCI,IOS_Masked,DisPuPd, GPIO_PADBAR+0x0160,  NORTH), // J6B2.09 SOC_COM1_RTS_N, Pull 4.22K to 1.8V High
#else
...
//[-start-181217-IB07401056-modify]//
  ...
  BXT_GPIO_PAD_CONF(L"GPIO_196 PANEL1_VDDEN",    M0  ,     GPO   ,GPIO_D,  LO     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,D0RxDRx0I ,   SAME,  GPIO_PADBAR+0x0048,  NORTHWEST), //#U6M2.02 V1P8_SW_CTRL          & J6M1.15 PANEL1_VDDEN_1_8V_R   & J6M1.09 PANEL1_VDDEN_3_3V_R
  BXT_GPIO_PAD_CONF(L"GPIO_197 PANEL1_BKLTEN",   M0  ,     GPO   ,GPIO_D,  LO     ,   NA      ,Wake_Disabled, P_20K_L,    NA   ,    NA  ,D0RxDRx0I ,   SAME,  GPIO_PADBAR+0x0050,  NORTHWEST), //#U6L1.02 OLED_EN               & J6M1.17 PANEL1_BKLTEN_1_8V_R  & J6M1.11 PANEL1_BKLTEN_3_3V_R
#else
...
//  BXT_GPIO_PAD_CONF(L"PMIC_I2C_SDA",             M0   ,    GPI   ,GPIO_D,  NA     ,   NA      ,Wake_Disabled,  P_NONE,   NA    ,    NA  ,IOS_Masked,     NA,  GPIO_PADBAR+0x0108,  NORTHWEST), //#FAB_ID0
  BXT_GPIO_PAD_CONF(L"PMIC_I2C_SCL",             M1   ,    NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_1K_H ,    NA   ,    NA  ,IOS_Masked,   SAME,  GPIO_PADBAR+0x0100,  NORTHWEST), // PMIC_I2C_SCL for Fab E
  BXT_GPIO_PAD_CONF(L"PMIC_I2C_SDA",             M1   ,    NA    , NA   ,  NA     ,   NA      ,Wake_Disabled, P_1K_H ,    NA   ,    NA  ,IOS_Masked,   SAME,  GPIO_PADBAR+0x0108,  NORTHWEST), // PMIC_I2C_SDA for Fab E
...
//[-start-190107-IB07401064-modify]//
  BXT_GPIO_PAD_CONF(L"GPIO_186 SDCARD_LVL_WP",     M0,     GPO   ,   NA   ,  LO     ,   Edge     ,Wake_Disabled, P_20K_L, Inverted,    NA  ,Last_Value, SAME,GPIO_PADBAR+0x00E0 ,  SOUTHWEST), // J6E2.09 SDCARD_LVL_R_WP SDCARD_LVL_WP
//[-end-190107-IB07401064-modify]//
...
#ifdef APOLLOLAKE_CRB
BXT_GPIO_PAD_INIT  mPreMemGpioInitData_LH[] =
#else
...
#ifdef APOLLOLAKE_CRB
BXT_GPIO_PAD_INIT  mSecGpioInitData_LH [] =
#else
