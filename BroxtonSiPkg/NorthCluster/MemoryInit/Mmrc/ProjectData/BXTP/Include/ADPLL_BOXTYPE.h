/** @file
  ...
  can be placed in ADPLL_BOXTYPE.h, which is used for non-tool-generated
  data
 ...
 @copyright
  ...
  @par Specification
**/
#ifndef _ADPLL_BOXTYPE_H_
#define _ADPLL_BOXTYPE_H_
...
#define PLLDIVRATIOS_0_ADPLL_BOXTYPE_REG                   0x00000000
#ifndef ASM_INC
typedef union {
  struct {
    //
    ...
    UINTX i_ndiv : 4;
    //
    // This register will be used to set the c73p1ddrlp34l64x1top_ADPLL internal FB divider
    // value when using long loop (external) division. At this mode the value in i_fbdivratio[7:0]
    // should reflect the true total division ratio (including the long loop division)
    // for the c73p1ddrlp34l64x1top_ADPLL calibration process
    //
  ...
  UINTX Data;
} PLLDIVRATIOS_0_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define PLLSEQUENCE_0_ADPLL_BOXTYPE_REG                    0x00000004
#ifndef ASM_INC
typedef union {
  struct {
    //
    ...
    UINTX o_locktimer : 1;
    //
    // c73p1ddrlp34l64x1top_ADPLL's Refclk request bit.
    //
  ...
  UINTX Data;
} PLLSEQUENCE_0_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define CONFIG_0_ADPLL_BOXTYPE_REG                         0x00000008
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} CONFIG_0_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define CONFIG_1_ADPLL_BOXTYPE_REG                         0x0000000C
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} CONFIG_1_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define CONFIG_2_ADPLL_BOXTYPE_REG                         0x00000010
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} CONFIG_2_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define CONFIG_3_ADPLL_BOXTYPE_REG                         0x00000014
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} CONFIG_3_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define FILTER_OBS_ADPLL_BOXTYPE_REG                       0x00000018
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} FILTER_OBS_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define VISA_OUT_ADPLL_BOXTYPE_REG                         0x0000001C
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} VISA_OUT_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define DFT_0_ADPLL_BOXTYPE_REG                            0x00000020
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} DFT_0_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define DFT_1_ADPLL_BOXTYPE_REG                            0x00000024
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} DFT_1_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define DFT_2_ADPLL_BOXTYPE_REG                            0x00000028
#ifndef ASM_INC
typedef union {
  struct {
    //
    ...
    UINTX lock_fail : 1;
    //
    // Indicator signal for narrow criteria c73p1ddrlp34l64x1top_ADPLL locking.
  ...
  UINTX Data;
} DFT_2_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define SFRCONFIG_0_ADPLL_BOXTYPE_REG                      0x0000002C
#ifndef ASM_INC
typedef union {
  struct {
    //
    ...
    //
    // set this bus to round((Frefclk / 20MHz) - 1) to allow c73p1ddrlp34l64x1top_ADPLL
    // generate an absolute timer for SFR trimming, SFR calibration, SFR on and DCO settle
    //
  ...
  UINTX Data;
} SFRCONFIG_0_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define DFT_BIST_ADPLL_BOXTYPE_REG                         0x00000030
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} DFT_BIST_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC

#define CALIB_MNTR_ADPLL_BOXTYPE_REG                       0x00000034
#ifndef ASM_INC
typedef union {
  struct {
    //
  ...
  UINTX Data;
} CALIB_MNTR_ADPLL_BOXTYPE_STRUCT;
#endif // ASM_INC


#endif // _ADPLL_BOXTYPE_H_
