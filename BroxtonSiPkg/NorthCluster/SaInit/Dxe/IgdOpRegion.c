...
//[-start-151015-IB02950552-add]//
#include <Protocol/LegacyBios.h>
//[-end-151015-IB02950552-add]//
  ...
  )
{
  ...
  UINT32                   VbtSize = 0;
//[-start-160817-IB07400772-add]//
  PLATFORM_GOP_POLICY_PROTOCOL  *PlatformGopPolicy;
//[-end-160817-IB07400772-add]//

  Status = EFI_NOT_FOUND;
  ///
  /// Get the HOB list.  If it is not present, then ASSERT.
  ///
//[-start-160817-IB07400772-modify]//
  Status = gBS->LocateProtocol (&gPlatformGOPPolicyGuid, NULL, (VOID **) &PlatformGopPolicy);
  if (!EFI_ERROR (Status)) {
...
/*++
   ...
   @exception EFI_UNSUPPORTED   Could not Get GOP driver version.
--*/
...
//[-start-151015-IB02950552-add]//
  ...
  EFI_STATUS                    Status;
//[-start-190610-IB16530029-add]//
  CHAR16                        GopVersion[16] = {0};
//[-end-190610-IB16530029-add]//
...
//[-end-151015-IB02950552-add]//
//[-start-151015-IB02950552-modify]//
  if (LegacyBios) {
...
//[-start-190610-IB16530029-add]//
      ...
      gBS->CopyMem (mIgdOpRegion.OpRegion->Header.DVER, GopVersion, StrSize(GopVersion));
//[-end-190610-IB16530029-add]//
  ...
  )
{
  ...
  ///
//[-start-190610-IB16530029-remove]//
//  Status = EfiCreateEventReadyToBootEx(
//                  TPL_CALLBACK,
//                  SetGOPVersionCallback,
//                  NULL,
...
//[-end-190610-IB16530029-remove]//
  ...
  ///
  /// Clear the B_ACPI_GPE0a_STS_GUNIT_SCI bit in R_ACPI_GPE0a_STS by writing a '1'.
  ///
