...
#define SW_GPE_FLASH_WORKAROUND   0x01
//[-end-161026-IB07400805-add]//
//[-start-161027-IB07400806-add]//
#define SW_GPE_DTS_EVENTS         0x02
...
//[-start-161028-IB07400806-modify]//
  UINT8       BspDigitalThermalSensorTemperature_Res; ///<   (06) Digital Thermal Sensor 1 Reading
  UINT8       ApDigitalThermalSensorTemperature_Res;  ///<   (07) Digital Thermal Sensor 2 Reading
...
//[-start-161028-IB07400806-modify]//
  UINT8       PrmrrStatus_Reserved;                   ///<   (342) SGX Feature Status
  UINT64      PrmrrBaseAddress_Reserved;              ///<   (343) SGX Feature PRMRR Base address
  UINT64      PrmrrSize_Reserved;                     ///<   (351) SGX Feature PRMRR Length (854-861)
//[-end-161028-IB07400806-modify]//
  UINT8       WorldCameraSel;                         ///<   (359) 0 - Disable, 1 - IMX214, 2 - IMX135/OV13858 , 3 - MT9V024, 4 - OV8856
...
//[-start-161028-IB07400806-modify]//
  UINT8       EnableDigitalThermalSensor_Reserved;    ///<   (562) Digital Thermal Sensor Enable
//[-end-161028-IB07400806-modify]//
  UINT8       Reserved2;                              ///<   (563) Reserved
  ...
  UINT8       Reserved6;                              ///<   (727) Reserved
  UINT8       Reserved7;                              ///<   (728) Reserved
...
//WiGig
  ...
  UINT8       Ipc1Enable;                             ///<   (870) IPC1Enable
  UINT8       OsDbgEnable;                            ///<   (871) OsDbgEnable
  UINT8       Ps2MouseEnable;                         ///<   (872) Ps2 Mouse Enable
  UINT8       Ps2KbMsEnable;                          ///<   (873) Ps2 Keyboard and Mouse Enable
  UINT32      Mmio32Base;                             ///<   (874) PCIE MMIO resource base
  UINT32      Mmio32Length;                           ///<   (878) PCIE MMIO resource length
  UINT8       CsmEnable;                              ///<   (882) CsmEnable
  ...
  UINT8       SdCardEnable;                           ///<   (918) SdCardEnable
  UINT8       SdioEnable;                             ///<   (919) SdioEnable
  UINT8       EmmcEnable;                             ///<   (920) EmmcEnable
  UINT8       EmmcHostMaxSpeed;                       ///<   (921) eMMC Host Max Speed
  UINT8       ConvertibleEnable;                      ///<   (922) Convertible enable
  UINT8       DockEnable;                             ///<   (923) Dock enable
  UINT8       VirtualGpioButtonSxBitmask;             ///<   (924) Bitmask for virtual GPIO button behavior in Sx wake scenario
  UINT8       PciePortRtd3BitMap;                     ///<   (925) Pcie Port bit map
  UINT32      PMCBase;                                ///<   (926) PMC base
//[-start-160429-IB07400722-add]//
  UINT8       FrcReserved[138];                       ///<   (930 ~ 1067) Reserved for FRC or Chipset
  UINT8       HideUnusedLpssDevices;                  ///<   (1068) Hide Unused LPSS Devices
//[-end-160429-IB07400722-add]//
//[-start-160809-IB07400769-add]//
  UINT8       TpmStatus;                              ///<   (1069) TPM Device Status
//[-end-160809-IB07400769-add]//
//[-start-160814-IB07400770-add]//
  UINT8       LegacyFreeSupport;                      ///<   (1070) Legacy Free Support
//[-end-160814-IB07400770-add]//
//[-start-161026-IB07400805-add]//
  UINT8       SwGpeFun;                               ///<   (1071) SW GPE Function
//[-end-161026-IB07400805-add]//
//[-start-170626-IB07400880-add]//
  UINT8       S5WakeOnUsbWaitTime;                    ///<   (1072) Wait Time for Wake on USB from S5
//[-end-170626-IB07400880-add]//
//[-start-170119-IB07401072-add]//
  UINT8       Mmio64AslSupport;                       ///<   (1072) Enable/Disable 64bits MMIO support
  UINT64      MmioMem64Base;                          ///<   (1073) 64 bits MMIO base address
  UINT64      MmioMem64Limit;                         ///<   (1081) 64 bits MMIO limit
  UINT64      MmioMem64Length;                        ///<   (1089) 64 bits MMIO length
