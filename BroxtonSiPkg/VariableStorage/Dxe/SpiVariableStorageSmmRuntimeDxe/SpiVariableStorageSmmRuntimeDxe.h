/** @file
  ...
  SPI Variable Storage Runtime DXE protocol.
...
#ifndef _SPI_VARIABLE_STORAGE_PROTOCOL_H_
#define _SPI_VARIABLE_STORAGE_PROTOCOL_H_
...
#include <Guid/SpiVariableStorageProtocolInstanceGuid.h>
