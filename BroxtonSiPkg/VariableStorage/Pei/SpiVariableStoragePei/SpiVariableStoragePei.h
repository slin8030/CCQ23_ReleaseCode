/** @file
  This file contains the required header files for the SPI Variable Storage PEIM.
...
#ifndef _SPI_VARIABLE_STORAGE_PEI_H_
#define _SPI_VARIABLE_STORAGE_PEI_H_
...
#include <Guid/SpiVariableStoragePpiInstanceGuid.h>
