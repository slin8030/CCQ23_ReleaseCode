...
extern EFI_GUID gVariableStorageSelectorPpiGuid;
...
typedef struct _VARIABLE_STORAGE_SELECTOR_PPI  VARIABLE_STORAGE_SELECTOR_PPI;
...
typedef
EFI_STATUS
(EFIAPI *PEI_VARIABLE_STORAGE_SELECTOR_GET_ID)(
...
///
struct _VARIABLE_STORAGE_SELECTOR_PPI {
  PEI_VARIABLE_STORAGE_SELECTOR_GET_ID    GetId;      ///< Retrieves an instance-specific variable storage ID
};
