/** @file
  ...
  The Variable Storage Protocol is used to acquire the variable storage
  instance ID (GUID) for a particular variable name and vendor GUID. This ID
  is used to find the appropriate variable storage Protocol.
...
extern EFI_GUID gVariableStorageSelectorProtocolGuid;
extern EFI_GUID gSmmVariableStorageSelectorProtocolGuid;
...
typedef struct _VARIABLE_STORAGE_SELECTOR_PROTOCOL  VARIABLE_STORAGE_SELECTOR_PROTOCOL;
...
typedef
EFI_STATUS
(EFIAPI *VARIABLE_STORAGE_SELECTOR_GET_ID)(
...
///
struct _VARIABLE_STORAGE_SELECTOR_PROTOCOL {
  VARIABLE_STORAGE_SELECTOR_GET_ID    GetId;      ///< Retrieves an instance-specific variable storage ID
};
