...
)
{
    ...
    //
    //  HeciEnableInterrupt should be called only after checking for HeciCseResponse
    //
...
//[-start-160725-IB10860204-add]//
      while(!IsHeciCseResponse()) {
        MicroSecondDelay (1000);
      }
//[-end-160725-IB10860204-add]//
	  HeciDisableInterrupt();
	  HeciClearInterrupt();
	  HeciEnableInterrupt();
	  // track IS bit again.
...
VOID CheckBXTBlackHole(UINT8 *Data)
{
  HECI2_BIOS_MESSAGE *Message;
  Message = (HECI2_BIOS_MESSAGE*)Data;
...
//[-start-160725-IB10860204-remove]//
//  CheckBXTBlackHole(Message);
//[-end-160725-IB10860204-remove]//
  return EFI_SUCCESS;
}
...
{
  if (IsHeciCseResponse()){
//    HeciReceiveInterrupt((UINT8*)MessageBody,Length);
	HeciInterruptHandle();
...
//[-start-160904-IB07400778-modify]//
//    return EFI_UNSUPPORTED;
    return EFI_SUCCESS;
//[-end-160904-IB07400778-modify]//
  }
//[-end-160701-IB06740505-add]//
