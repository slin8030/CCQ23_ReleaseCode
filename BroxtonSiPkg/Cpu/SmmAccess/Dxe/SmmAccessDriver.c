...
//[-start-160712-IB07400756-add]//
  if (PcdGet8(PcdIsHeadlessMode)) {
    //
    // Enable A-B Segment in DRAM for Legacy Headless Mode Support
    //
    Mmio32Or(MCH_BASE_ADDRESS, BUNIT_BMISC_MCHBAR_OFFSET, B_BMISC_ABSEGINDRAM);
  }
//[-end-160712-IB07400756-add]//
  return EFI_SUCCESS;
}
...
//[-start-160712-IB07400756-add]//
  if (PcdGet8(PcdIsHeadlessMode)) {
    //
    // Disable A-B Segment in DRAM
    //
    Mmio32And (MCH_BASE_ADDRESS, BUNIT_BMISC_MCHBAR_OFFSET, (~B_BMISC_ABSEGINDRAM));
  }
//[-end-160712-IB07400756-add]//
