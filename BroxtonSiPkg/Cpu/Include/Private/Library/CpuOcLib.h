...
/**
  Get the DDR capabilities information

  @param[out] *DdrCapabilies
  @param[out] *LibStatus

  @retval EFI_STATUS
**/
EFI_STATUS
EFIAPI GetDdrCapabilites (
  OUT OC_CAPABILITIES_ITEM *DdrCapabilities,
  OUT UINT32               *LibStatus
  );
...
/**
  ...
  @param[in] SiCpuPolicyPpi      Pointer to SiCpu Policy Ppi instance
