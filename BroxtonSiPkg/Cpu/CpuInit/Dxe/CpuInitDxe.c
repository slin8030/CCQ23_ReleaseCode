  ...
  )
{
  ...
  // Change Boot Personality At End of Boot (Set Untrusted Mode)
  //
  Status = SetUntrustedMode ();
  ASSERT_EFI_ERROR (Status);
}

//[-end-181228-IB16840050-add]//
/**
...
//[-start-181228-IB16840050-modify]//
  EFI_EVENT         EndOfDxeEvent;
  // EFI_EVENT         ExitBootServiceEvent;
//[-end-181228-IB16840050-modify]//
  VOID              *Hob;
...
//[-start-150520-IB03090000-add]//
  Status  = gBS->LocateProtocol (&gEfiMetronomeArchProtocolGuid, NULL, (VOID **) &mMetronome);
  ASSERT_EFI_ERROR (Status);
  if (EFI_ERROR (Status)) {
    return Status;
  }
//[-end-150520-IB03090000-add]//
...
//[-start-150520-IB03090000-remove]//
//  Status  = gBS->LocateProtocol (&gEfiMetronomeArchProtocolGuid, NULL, (VOID **) &mMetronome);
//  if (EFI_ERROR (Status)) {
//    return Status;
//  }
//[-end-150520-IB03090000-remove]//
