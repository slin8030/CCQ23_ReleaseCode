...
//[-start-161027-IB07400806-add]//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GLOBAL_NVS_AREA *mEfiGlobalNvsAreaPtr = NULL;
//[-end-161027-IB07400806-add]//
...
//[-start-161027-IB07400806-modify]//
    ...
    /// Enable SW GPE
    ///
    GpeCntl = IoRead32(mAcpiBaseAddr + R_ACPI_GPE0a_EN);
    GpeCntl |= B_ACPI_GPE0a_EN_SWGPE_EN;
    IoWrite32(mAcpiBaseAddr + R_ACPI_GPE0a_EN, GpeCntl);

    //
    // Set SW GPE function
    //
    mEfiGlobalNvsAreaPtr->SwGpeFun = SW_GPE_DTS_EVENTS;
...
//    DEBUG ((DEBUG_INFO, "CPU DTS Threshold #2 - %x\n", MsrData.Bytes.ThirdByte));
    DEBUG ((DEBUG_INFO, "CPU DTS (Currect Temperature, Threshold #2, Threshold #1) "));
    DEBUG ((DEBUG_INFO, "(%03d, %03d, %03d)\n", 
      Temperature,
      mDtsTjMax - (MsrData.Bytes.ThirdByte & OFFSET_MASK),
      mDtsTjMax - (MsrData.Bytes.SecondByte & OFFSET_MASK)
      ));
...
//[-start-161027-IB07400806-modify]//
  EFI_GLOBAL_NVS_AREA_PROTOCOL              *EfiGlobalNvsAreaProtocol = NULL;
//[-end-161027-IB07400806-modify]//
...
//[-start-161027-IB07400806-add]//
  ///
  /// Locate EFI Global NVS area
  ///
  Status = gBS->LocateProtocol (&gEfiGlobalNvsAreaProtocolGuid, NULL, (VOID **) &EfiGlobalNvsAreaProtocol);
  ASSERT_EFI_ERROR (Status);
  mEfiGlobalNvsAreaPtr = EfiGlobalNvsAreaProtocol->Area;
  DEBUG ((DEBUG_WARN, "mEfiGlobalNvsAreaPtr = %x\n", mEfiGlobalNvsAreaPtr));
//[-end-161027-IB07400806-add]//
