...
//[-end-160912-IB07400782-modify]//
  ...
  //
  // Workarround for PS2 KB lock LED is glow after wram reset in shell.
  // trun off lock LED before reset
  //
//[-start-160912-IB07400782-modify]//
//#if (ENBDT_PF_ENABLE == 1)
#ifdef KSC_SIO_SUPPORT
...
//[-start-170314-IB07400847-add]//
      //
      // Hook Platform Shutdown Settings by Setup
      //
      IoWrite8 (R_APM_STS, CHIPSET_MISC_SW_SMI_SHUTDOWN_HOOK);
      IoWrite8 (R_APM_CNT, CHIPSET_MISC_SW_SMI);
//[-end-170314-IB07400847-add]//
  ...
  )
{
  ...
  if (ScExtendedResetTypes.GlobalReset == 1) {
    MmioOr32 (mResetInstance->PmcBase + R_PMC_ETR, (UINT32) (B_PMC_ETR_CF9GR));
  }
