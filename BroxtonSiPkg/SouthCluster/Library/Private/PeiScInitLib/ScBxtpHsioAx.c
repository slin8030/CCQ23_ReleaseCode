...
//[-start-160829-IB07400775-remove]//
...
//  0xA00,
//};
//[-end-160829-IB07400775-remove]//

SC_SBI_HSIO_TABLE_STRUCT ScBxtpHsioTable_Ax[] = {
   ...
   {0xA5, 0xFFFFFF00,       0x16, 0x8008, SC_LANE_OWN_COMMON},         // LANE
   {0xB1, 0xFFFFFF00,       0x16, 0x8008, SC_LANE_OWN_COMMON},         // LANE
   ...
   {0xA5, 0xFDFF00FF,  0x2000500,   0x04, V_SC_PCR_FIA_LANE_OWN_PCIE}, // UNICAST
   {0xA5, 0xFFFF00FF,     0x0500,   0x04, V_SC_PCR_FIA_LANE_OWN_USB3}, // UNICAST
   {0xA5, 0xFBFF00FF,  0x4000500,   0x04, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   ...
   {0xA5, 0xFF000000,   0x3F516F,   0x90, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   ...
   {0xA5, 0xFF000000,   0x12C70A,  0x140, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   ...
   {0xA5, 0xE1FFFFFF, 0x1E000000,  0x1CC, V_SC_PCR_FIA_LANE_OWN_PCIE}, // UNICAST
   {0xA5, 0xE1FFFFF8, 0x1E000000,  0x1CC, V_SC_PCR_FIA_LANE_OWN_USB3}, // UNICAST
   {0xA5, 0xE1FFFFFF, 0x1E000000,  0x1CC, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   ...
   {0xA5, 0xC0C0C0FF, 0x023F0100,  0x16C, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   {0xA5, 0xFFDFC0FF,   0x203F00,  0x178, V_SC_PCR_FIA_LANE_OWN_PCIE}, // UNICAST
   {0xA5, 0xFFFFFF18,       0xC6,  0x178, V_SC_PCR_FIA_LANE_OWN_USB3}, // UNICAST
   {0xA5, 0xFFDFC018,   0x2027C6,  0x178, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   ...
   {0xA5, 0xFF80FFFF,    0x80000,  0x17C, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
   {0xA5, 0xC0C0FFFF, 0x3C020000,  0x158, V_SC_PCR_FIA_LANE_OWN_USB3}, // UNICAST
   {0xA5, 0xFFC0FFFF,    0x80000,  0x158, V_SC_PCR_FIA_LANE_OWN_SATA}, // UNICAST
...
SC_SIDEBAND_TABLE_STRUCT ScBxtpUsb2PhyCommonTable_A0[] = {
  ...
  {R_PCR_USB2_SFRCONFIG_0,      0xFFFFFCFF, 0x00000300}
};

SC_SIDEBAND_TABLE_STRUCT ScBxtpUsb2PhyPerPortTable_A0[] = {
  {R_PCR_USB2_PPORT,   0x03F180EF, 0xFC082810},
  {R_PCR_UTMI_MISC_PR, 0xFFFFC17F, 0x00001A80},
  {R_PCR_USB2_PPORT2,  0xFC7FFFFC, 0x03800003}
};

SC_SIDEBAND_TABLE_STRUCT ScBxtpSsicModphy_Ax_RateA[] = {
...
SC_SIDEBAND_TABLE_STRUCT ScBxtpSsicModphy_Ax_RateB[] = {
...
SC_SIDEBAND_TABLE_STRUCT ScBxtpSsicModphy_Ax_RateB_Dlane_PG[] = {
  //Enable Dlane Power gating
  //CFG_UPDATE(); dlane2.impreg8.[25:24] = b'11
  // clane.cmnreg1.hfpll_enable = 0; cfg_updt()
  { R_SC_PCR_MMP0_CMNREG1, 0xfffffeff, 0x00000000 },
