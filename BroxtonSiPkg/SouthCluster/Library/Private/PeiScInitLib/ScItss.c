  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "ConfigureItss() Start\n"));
...
if ((PLATFORM_ID == VALUE_REAL_PLATFORM) ||
    ...
    DEBUG ((DEBUG_INFO, "Start SC_PM_ENABLE\n"));
      ...
      if (PmConfig->Timer8254ClkGateEn == FALSE){
        Data32And = (UINT32)~BIT2;
        Data32Or = BIT4 | BIT3 | BIT1 | BIT0;
      }
  ...
  DEBUG ((DEBUG_INFO, "ConfigureItss() End\n"));
