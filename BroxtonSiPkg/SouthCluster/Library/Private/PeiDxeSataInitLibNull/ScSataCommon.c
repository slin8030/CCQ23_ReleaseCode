...
**/
#include "ScSataCommon.h"

/**
  Configures SC Sata Controller for SC

#ifdef SC_PO_FLAG
  @param[in] SataSafeRegister               The safe setting register for SATA
#endif // SC_PO_FLAG
  @param[in]      SataConfig                The SC Policy for SATA configuration
  @param[in,out]  SataDisabled              A Boolean to indicate if Sata Controller should be disabled
