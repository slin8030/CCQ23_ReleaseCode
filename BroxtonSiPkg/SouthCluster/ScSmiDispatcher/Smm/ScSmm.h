...
/**
  ...
  @retval TRUE       Context1 and Context2 is same.
          FALSE      Context1 and Context2 is diffrent.
...
/**
  Clear the SMI status bit after the USB SMI handling is done
...
/**
  The IoTrapControl module abstracts SC I/O trapping capabilities for other drivers.
