...
/**
  ...
  @param [in] FormSet     The FormSet.
  @param [in] Statement   The numeric question whose VarStoreInfo.VarName is the
...
/**
  ...
  @param [in] OpCodeData     The current opcode.
  ...
  )
{
  ...
  if (FormSet->LinkStatementListHead.ForwardLink != NULL) {
