...
set DEVTLS_DIR=BuildCode\DEVTLS_T599

REM ASL Compiler Path, example: "B:\BuildCode\DEVTLS-T190\Asl\Acpi5.0"
set ASL_PATH=B:\BuildCode\DEVTLS_T599\Asl\Acpi5.0
...
REM 
set INPUT_FIT_XML_FOR_SPI=bxt_spi_8mb_Island
set INPUT_FIT_XML_FOR_EMMC=bxt_emmc_8mb_Island
REM [-end-160421-IB07400719-add]REM

REM BIOS Image Name in BIOS folder. If not defined, use SOC Name & CRB borad Name.
REM [-start-180516-IB07400967-modify]REM
set BIOS_NAME=%SOC_NAME%_Island
REM [-end-180516-IB07400967-modify]REM

REM Include user path, example: "B:\BuildCode\DEVTLS-T190\MyBAT5.0"
path=B:\BuildCode\DEVTLS_T599\MyBAT5.0;%path%
