...
BXT_GPIO_PAD_CONF(L"GPIO_2", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0010, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_3", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0018, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_4", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0020, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_5", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0028, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_6", M0, NA, NA, NA, Level, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0030, NORTH),
//BXT_GPIO_PAD_CONF(L"GPIO_7", M7, HI_Z, NA, NA, Both, Wake_Disabled, P_20K_L, Inverted, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0038, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_8", M5, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0040, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_9", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0048, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_10", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0050, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_11", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0058, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_12", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0060, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_13", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0068, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_14", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0070, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_15", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0078, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_16", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0080, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_17", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0088, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_18", M0, GPI, GPIO_D, NA, Level, Wake_Enabled, P_20K_H, Inverted, IOAPIC, TxDRxE, SAME, GPIO_PADBAR+0x0090, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_19", M0, GPI, GPIO_D, NA, NA, Wake_Enabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0098, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_20", M0, GPI, ACPI_D, NA, Edge, Wake_Enabled, P_20K_L, NA, IOAPIC, TxDRxE, SAME, GPIO_PADBAR+0x00A0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_21", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00A8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_22", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x00B0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_23", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00B8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_24", M5, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00C0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_25", M0, GPI, ACPI_D, NA, Level, Wake_Enabled, P_20K_H, Inverted, SCI, Last_Value, SAME, GPIO_PADBAR+0x00C8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_26", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00D0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_27", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00D8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_28", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00E0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_29", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x00E8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_30", M0, HI_Z, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00F0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_31", M5, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x00F8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_32", M5, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0100, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_33", M5, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x0108, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_34 PWM0", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0110, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_35 PWM1", M0, GPO, NA, HI, NA, Wake_Disabled, P_5K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0118, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_36 PWM2", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0120, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_37 PWM3", M1, NA, NA, NA, Level, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0128, NORTH),
...
BXT_GPIO_PAD_CONF(L"GPIO_49 LPSS_UART2_CTS_B", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0188, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_62 GP_CAMERASB00", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x0190, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_63 GP_CAMERASB01", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x0198, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_64 GP_CAMERASB02", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01A0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_65 GP_CAMERASB03", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01A8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_66 GP_CAMERASB04", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01B0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_67 GP_CAMERASB05", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01B8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_68 GP_CAMERASB06", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01C0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_69 GP_CAMERASB07", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01C8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_70 GP_CAMERASB08", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01D0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_71 GP_CAMERASB09", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01D8, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_72 GP_CAMERASB10", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01E0, NORTH),
BXT_GPIO_PAD_CONF(L"GPIO_73 GP_CAMERASB11", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x01E8, NORTH),
...
BXT_GPIO_PAD_CONF(L"GPIO_218 CNV_RGI_DT", M0, GPO, NA, HI, NA, Wake_Disabled, P_1K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0248, NORTH),
...
{
  //                 Group Pin#:  pad_name,     PMode,GPIO_Config,HostSw,GPO_STATE,INT_Trigger, Wake_Enabled, Term_H_L,Inverted,GPI_ROUT,IOSstae,  IOSTerm,     MMIO_Offset    ,  Community */
BXT_GPIO_PAD_CONF(L"GPIO_187 HV_DDI0_DDC_SDA", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x0000, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_188 HV_DDI0_DDC_SCL", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, HizRx0I, SAME, GPIO_PADBAR+0x0008, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_191 DBI_SDA", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0020, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_192 DBI_SCL", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0028, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_196 PANEL1_VDDEN", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0048, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_197 PANEL1_BKLTEN", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0050, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_198 PANEL1_BKLTCTL", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0058, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_199 DBI_CSX", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0060, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_200 DBI_RESX", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0068, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_201 GP_INTD_DSI_TE1", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, D0RxDRx0I, SAME, GPIO_PADBAR+0x0070, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_202 GP_INTD_DSI_TE2", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, D0RxDRx0I, SAME, GPIO_PADBAR+0x0078, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_213 PMIC_SDWN_B", M0, GPO, NA, HI, NA, Wake_Disabled, P_NONE, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00D0, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_214 PMIC_BCUDISW2", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00D8, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_215 PMIC_BCUDISCRIT", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00E0, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_74 AVS_I2S1_MCLK", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0110, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_75 AVS_I2S1_BCLK", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0118, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_76 AVS_I2S1_WS_SYNC", M0, GPO, NA, HI, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0120, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_77 AVS_I2S1_SDI", M0, GPI, ACPI_D, NA, NA, Wake_Enabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0128, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_78 AVS_I2S1_SDO", M0, GPI, ACPI_D, NA, NA, Wake_Enabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0130, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_104 GP_SSP_0_CLK", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x01E8, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_109 GP_SSP_0_RXD", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0200, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_110 GP_SSP_0_TXD", M0, GPO, NA, LO, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0208, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_112 GP_SSP_1_FS0", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0218, NORTHWEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_116 GP_SSP_1_RXD", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0228, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_117 GP_SSP_1_TXD", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0230, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_118 GP_SSP_2_CLK", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0238, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_119 GP_SSP_2_FS0", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0240, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_120 GP_SSP_2_FS1", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0248, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_121 GP_SSP_2_FS2", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0250, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_122 GP_SSP_2_RXD", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0258, NORTHWEST),
BXT_GPIO_PAD_CONF(L"GPIO_123 GP_SSP_2_TXD", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x0260, NORTHWEST),
};
...
BXT_GPIO_PAD_CONF(L"GPIO_134 ISH_I2C0_SDA", M2, NA, NA, NA, NA, Wake_Disabled, P_1K_H, NA, NA, IOS_Masked, EnPu, GPIO_PADBAR+0x0050, WEST),
BXT_GPIO_PAD_CONF(L"GPIO_135 ISH_I2C0_SCL", M2, NA, NA, NA, NA, Wake_Disabled, P_1K_H, NA, NA, IOS_Masked, EnPu, GPIO_PADBAR+0x0058, WEST),
BXT_GPIO_PAD_CONF(L"GPIO_136 ISH_I2C1_SDA", M2, NA, NA, NA, NA, Wake_Disabled, P_1K_H, NA, NA, IOS_Masked, EnPu, GPIO_PADBAR+0x0060, WEST),
BXT_GPIO_PAD_CONF(L"GPIO_137 ISH_I2C1_SCL", M2, NA, NA, NA, NA, Wake_Disabled, P_1K_H, NA, NA, IOS_Masked, EnPu, GPIO_PADBAR+0x0068, WEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_150 ISH_GPIO_4", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00A0, WEST),
...
BXT_GPIO_PAD_CONF(L"GPIO_152 ISH_GPIO_6", M2, NA, NA, NA, NA, Wake_Disabled, P_20K_L, NA, NA, Last_Value, SAME, GPIO_PADBAR+0x00B0, WEST),
...
BXT_GPIO_PAD_CONF(L"SMB_ALERTB", M1, NA, NA, NA, NA, Wake_Disabled, P_20K_H, NA, NA, IOS_Masked, SAME, GPIO_PADBAR+0x00F8, SOUTHWEST),
};
#endif
