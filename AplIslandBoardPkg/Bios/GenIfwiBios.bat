...
REM [-start-180517-IB07400967-add]REM
...
REM [-end-180517-IB07400967-add]REM
...
REM [-start-181001-IB07401020-modify]REM
if %BUILD_PLATFORM_TYPE%==ApolloLake_RVP1 (
  set CRB_GEN_APL_RVP1_FULL_BIOS=YES
  if defined INPUT_FIT_XML_FOR_SPI set CRB_APL_RVP1_XML_FOR_SPI=%INPUT_FIT_XML_FOR_SPI%
  if defined INPUT_FIT_XML_FOR_EMMC set CRB_APL_RVP1_XML_FOR_EMMC=%INPUT_FIT_XML_FOR_EMMC%
)
if %BUILD_PLATFORM_TYPE%==ApolloLake_RVP2 (
  set CRB_GEN_APL_RVP2_FULL_BIOS=YES
  if defined INPUT_FIT_XML_FOR_SPI set CRB_APL_RVP2_XML_FOR_SPI=%INPUT_FIT_XML_FOR_SPI%
  if defined INPUT_FIT_XML_FOR_EMMC set CRB_APL_RVP2_XML_FOR_EMMC=%INPUT_FIT_XML_FOR_EMMC%
)
if %BUILD_PLATFORM_TYPE%==ApolloLakeI_OxbowHill (
  set CRB_GEN_APLI_OXH_FULL_BIOS=YES
  if defined INPUT_FIT_XML_FOR_SPI set CRB_APLI_OXH_XML_FOR_SPI=%INPUT_FIT_XML_FOR_SPI%
  if defined INPUT_FIT_XML_FOR_EMMC set CRB_APLI_OXH_XML_FOR_EMMC=%INPUT_FIT_XML_FOR_EMMC%
)
...
REM [-end-181001-IB07401020-modify]REM
