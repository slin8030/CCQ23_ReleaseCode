...
#ifndef _SIO_IT8987E_HII_RESOURCE_H_
#define _SIO_IT8987E_HII_RESOURCE_H_
...
// create a packagelist (which contains Form packages, String packages, etc).
//
extern UINT8  SioIt8987eDxeStrings[];
...
/**
  Init Hardware Monitor menu in SCU.

  @param[in]   PrivateData       Points to the EFI_HII_CONFIG_ACCESS_PROTOCOL.
  @param[in]   HwmGuid           Which type in, like voltage, fan...
