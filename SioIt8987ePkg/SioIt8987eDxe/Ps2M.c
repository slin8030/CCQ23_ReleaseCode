  ...
  )
{
  ...
  //
  // Io base is at keyboard's LDN
  //
  IDW8 (SIO_LDN, SIO_KYBD, mSioResourceFunction);
  (*ResourceList)->IoPort = (UINT16) (((IDR8(SIO_BASE_IO_ADDR2_MSB, mSioResourceFunction))<<8) + IDR8(SIO_BASE_IO_ADDR2_LSB, mSioResourceFunction));

  //
  // IRQ is at mouse's LDN
  //
