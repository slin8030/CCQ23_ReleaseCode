...
!import SioIt8987ePkg/Package.dsc
...
#[-start-180103-IB07400939-add]#
  gSioGuid.PcdSioIt8987eSetup|$(KSC_SIO_SUPPORT)
  gSioGuid.PcdSioIt8987eUpdateAsl|$(KSC_SIO_SUPPORT)
  gSioGuid.PcdSioIt8987eSupported|$(KSC_SIO_SUPPORT)
#[-end-180103-IB07400939-add]#
...
#[-start-180103-IB07400939-add]#
  gSioGuid.PcdSioIt8987eCfg|{ \
    ...
    #-----------------------------------------------------------------------------
    0x89, 0x87, 0x00, 0x01, 0x00, 0x00, UINT16(0x03F8), 0x08, 0x00, 0x04, 0x00,    \ # Com1
...
#[-start-171218-IB07400935-add]#
  PlatformVfrLib|$(CHIPSET_PKG)/UefiSetupUtilityDxe/PlatformVfrLib.inf {
    <SOURCE_OVERRIDE_PATH>
      $(PROJECT_OVERRIDE)/$(CHIPSET_PKG)/UefiSetupUtilityDxe
  }
  EcLib|$(PROJECT_PKG)/Library/BaseEcLib/BaseEcLib.inf
  EcHwLib|$(PROJECT_PKG)/Library/BaseEcHwLib/BaseEcHwLib.inf
  EcMiscLib|$(PROJECT_PKG)/Library/BaseEcMiscLib/BaseEcMiscLib.inf
#[-end-171218-IB07400935-add]#
#[-start-180103-IB07400939-add]#
...
!if $(GOP_DRIVER_ENABLE) == YES
  $(CHIPSET_PKG)/PlatformGopPolicy/PlatformGopPolicy.inf {
    <SOURCE_OVERRIDE_PATH>
      $(PROJECT_OVERRIDE)/$(CHIPSET_PKG)/PlatformGopPolicy
  }
!endif
#[-end-171218-IB07400935-add]#
