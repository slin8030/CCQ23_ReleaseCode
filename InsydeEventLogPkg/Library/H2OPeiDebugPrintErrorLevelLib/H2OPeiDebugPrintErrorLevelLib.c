/** @file
 H2OPeiDebugPrintErrorLevelLib Lib functions which relate with connect the device
...
//[-start-160219-IB08400332-modify]//  
    DebugPrintErrorLevel = DebugCfgToErrLevel((VOID*)&DebugMsgCfg);  
