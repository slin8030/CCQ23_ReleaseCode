...
#ifndef _POST_MESSAGE_DXE_H_
#define _POST_MESSAGE_DXE_H_
...
// Unicode POST Message('_MPU') and ASCII POST Message('_MPA')
//
...
#define UNICODE_POST_MESSAGE_SIZE               (POST_MESSAGE_SIZE/2)                          // UPM Size
#define ASCII_POST_MESSAGE_SIZE                 (POST_MESSAGE_SIZE-UNICODE_POST_MESSAGE_SIZE)  // APM Size                                                  BEHAVIOR_STORE_MESSAGE | BEHAVIOR_EVENT_BEEP)
...
typedef struct {
  ...
  UINT32                  UpmStartAddr;             // Unicode POST Message Start Address
  UINT32                  UpmEndAddr;               // Unicode POST Message End Address
  UINT32                  UpmSize;                              
  UINT32                  ApmSignature;             // 'APM_'
  UINT32                  ApmStartAddr;             // ASCII POST Message Start Address
  UINT32                  ApmEndAddr;               // ASCII POST Message End Address  
  UINT32                  ApmSize;
