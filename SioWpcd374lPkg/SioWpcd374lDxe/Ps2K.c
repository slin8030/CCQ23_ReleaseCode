  ...
  ) 
{
  ...
  EnterConfigMode ();
  IDW8 (SIO_LDN, Ldn, mSioResourceFunction);  
  IDW8 (SIO_BASE_IO_ADDR1_MSB, (UINT8)((ResourceList->IoPort >> 8) & 0xff), mSioResourceFunction);
  IDW8 (SIO_BASE_IO_ADDR1_LSB, (UINT8)(ResourceList->IoPort & 0xff), mSioResourceFunction);
  IDW8 (SIO_BASE_IO_ADDR2_MSB, (UINT8)((ResourceList->IoPort >> 8) & 0xff), mSioResourceFunction);
  IDW8 (SIO_BASE_IO_ADDR2_LSB, (UINT8)((ResourceList->IoPort & 0xff) + 4), mSioResourceFunction);  
