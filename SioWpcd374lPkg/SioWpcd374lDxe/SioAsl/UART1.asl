...
//[-start-161221-IB07400829-add]//
    //
    // COM1 is debug port, hide this device if debug feature is enabled.
    //
#if defined(H2ODDT_COM_SUPPORT) || defined(UART_POST_CODE_VIA_LEGACY_COM_PORT)    
    Return (0)
#endif
//[-end-161221-IB07400829-add]//
